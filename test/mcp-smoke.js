...
(async () => {
    ...
    try {
        ...
        response = await rpc({ jsonrpc: '2.0', id: 7, method: 'tools/call', params: {} });
        ...
        response = await rpc({ jsonrpc: '2.0', id: 8, method: 'tools/call', params: { name: '' } });
        ...
        response = await rpc({ jsonrpc: '2.0', id: 9, method: 'tools/call', params: { name: '   ' } });
        ...
        response = await rpc({ jsonrpc: '2.0', id: 10, method: 'tools/call', params: { name: 42 } });
        ...
        response = await rpc({ jsonrpc: '2.0', id: 11, method: 'tools/call', params: { name: 'unknown_tool_xyz' } });
        ...
        response = await rpc({ jsonrpc: '2.0', id: 12, method: 'tools/call', params: { name: 'Run_Terminal_Command' } });
