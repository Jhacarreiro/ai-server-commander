...
1. The client sends a Bearer-authenticated GET or POST request. `HEAD` is rejected with `405` before parsing, because Express would otherwise route it to the GET handler.
