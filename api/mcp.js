    ...
    async function handleRequest(message, req) {
        ...
        if (method === 'initialize') {
            return jsonRpcResult(id, {
                ...
                capabilities: { tools: {} },
                serverInfo: { name: 'remote-terminal', version: packageVersion },
                instructions: 'This MCP server exposes bounded remote terminal execution on the remote host. Use run_terminal_command only with explicit user approval and prefer short, verifiable commands. Multi-line scripts are supported with mode=script.'
            });
        }
