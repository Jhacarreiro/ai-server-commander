    ...
    async function handleRequest(message, req) {
        ...
        if (method === 'tools/call') {
            ...
            if (typeof params.arguments === 'string' && params.arguments.trim()) {
                ...
                return jsonRpcError(id, -32602, 'arguments must be an object or a JSON object string, not an array');
            } else if (params.arguments !== undefined && params.arguments !== null && typeof params.arguments !== 'object') {
                return jsonRpcError(id, -32602, 'arguments must be an object or a JSON object string, not ' + typeof params.arguments);
            }
