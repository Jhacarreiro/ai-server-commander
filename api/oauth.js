...
<html><head><meta charset="utf-8"><title>Authorize Remote Terminal</title></head>
<body style="font-family: system-ui, sans-serif; max-width: 720px; margin: 48px auto; line-height: 1.45;">
<h1>Authorize Remote Terminal</h1>
<p>This connector can run shell commands on the remote host through the <code>run_terminal_command</code> MCP tool.</p>
...
function protectedResourceMetadataUrl(config) {
    const base = String(config.productionDomain || '').replace(/\/$/, '') || 'https://terminal.example.invalid';
